app.component("Resume", {
    ...
    <section class="Resume" id="resume">
        <header>
            ...
            <a download href="./OmarGuadarrama___resume.pdf" target="_blank" class="downloadIcon">
            ...
            <article class="contact">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <p> <a href="https://github.com/Herkom" target="_blank" >Github</a> </p>
                    </li>
                    <li>
                        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2 2">
                        ...
                        <p> <a href="#gallery">omarguadarrama.com</a> </p>
                    </li>
                    <li>
                        <svg id="Layer_1" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 2 2">
