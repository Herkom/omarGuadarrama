import type { JobItem } from "@/types/jobItems";

const jobItems: JobItem[] = [
  {
    name: "Extracto",
    description:
      "Las noticias más relevantes de los medios locales del Estado de Tabasco, México.",
  ...
  },
  {
    ...
    description:
      "Calendario de Obligaciones Generales de los Entes Públicos del Estado de Tabasco",
  ...
  },
  {
    ...
    description:
      "Formulario de registro para la Bolsa de Trabajo del Órgano Superior de Fiscalización del Estado de Tabasco",
  ...
  },
  {
    ...
    description:
      "Sitio Web Oficial del Órgano Superior de Fiscalización del Estado de Tabasco",
    ...
    images: ["osfeTabasco_0.jpg", "osfeTabasco_1.jpg", "osfeTabasco_2.jpg"],
    conclusion: [
  ...
  },
  {
    ...
    images: ["reygar1.jpg", "reygar2.jpg"],
    conclusion: [
  ...
  },
  {
    ...
    description: "",
    link: [
      "https://www.youtube.com/results?search_query=dosis+de+ciencia+drucker",
      "https://vimeo.com/search?q=Dosis%20de%20ciencia",
    ],
